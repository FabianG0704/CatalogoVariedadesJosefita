                                          --          \i C:\Users\Asus\Downloads\bdproyecto.sql

-- '01.- BLOQUE PARA CREAR BDJOSEFITA'
...
SELECT 'Paso 2 Listado de las BD Proyecto .....' as paso;
\l
...
CREATE TABLE tmprendas (
    ...
    fkcod_sx_p varchar(1) not null,

    foreign key (fkcod_s_p) references tmstatus(pkcod_s) on update cascade on delete restrict,
    foreign key (fkcod_sx_p) references tmsexo(pkcod_sx) on update cascade on delete restrict );


INSERT INTO tmprendas (pkcod_p, Nom_P, talla,fkcod_sx_p, color, precio, fkcod_s_p) VALUES   (1,  'Camisa Futbol', 'M','F', 'Rojo', 25000,1);
INSERT INTO tmprendas (pkcod_p, Nom_P, talla, fkcod_sx_p, color, precio, fkcod_s_p) VALUES
(2,  'Camiseta Deportiva', 'S','M', 'Negro', 35000,1),
(3,  'Camiseta Casual', 'M','F', 'Blanco', 40000,1),
(4,  'Camiseta Running', 'L','M', 'Azul', 55000,1),
(5,  'Camiseta Estampada', 'M','F', 'Rosado', 45000,1),
(6,  'Camiseta Gym', 'S','M', 'Gris', 38000,1),
(7,  'Camiseta Oversize', 'L','F', 'Beige', 60000,1),
(8,  'Camiseta Fútbol', 'M','M', 'Verde', 70000,1),
(9,  'Camiseta Casual', 'S','F', 'Amarillo', 32000,1),
(10, 'Camiseta Deportiva', 'XL','M', 'Negro', 65000,1),
(11, 'Camiseta Estampada', 'M','F', 'Blanco', 48000,1),
(12, 'Camiseta Running', 'L','M', 'Rojo', 72000,1),
(13, 'Camiseta Casual', 'S','F', 'Azul', 36000,1),
(14, 'Camiseta Gym', 'M','M', 'Gris', 50000,1),
(15, 'Camiseta Oversize', 'L','F', 'Negro', 75000,1),
(16, 'Camiseta Fútbol', 'M','M', 'Blanco', 80000,1),
(17, 'Camiseta Casual', 'XL','F', 'Verde', 52000,1),
(18, 'Camiseta Deportiva', 'S','M', 'Rojo', 43000,1),
(19, 'Camiseta Estampada', 'M','F', 'Lila', 47000,1),
(20, 'Camiseta Running', 'L','M', 'Azul', 68000,1),
(21, 'Camiseta Casual', 'S','F', 'Negro', 34000,1),
(22, 'Camiseta Gym', 'M','M', 'Blanco', 57000,1),
(23, 'Camiseta Oversize', 'XL','F', 'Gris', 90000,1),
(24, 'Camiseta Fútbol', 'L','M', 'Rojo', 95000,1),
(25, 'Camiseta Casual', 'M','F', 'Beige', 41000,1),
(26, 'Camiseta Deportiva', 'S','M', 'Azul', 37000,1),
(27, 'Camiseta Estampada', 'L','F', 'Amarillo', 62000,1),
(28, 'Camiseta Running', 'M','M', 'Negro', 78000,1),
(29, 'Camiseta Casual', 'S','F', 'Blanco', 33000,1),
(30, 'Camiseta Gym', 'L','M', 'Verde', 69000,1),
(31, 'Camiseta Oversize', 'M','F', 'Rosado', 85000,1);
